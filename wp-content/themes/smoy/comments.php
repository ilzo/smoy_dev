...
<div id="comments" class="comments-area">
		...
		<h2 class="comments-title">
			<?php
				...
				if ( '1' === $comments_number ) {
					...
					printf( _x( 'One Reply to &ldquo;%s&rdquo;', 'comments title', 'smoy' ), get_the_title() );
				} else {
					printf(
		...
		<ol class="comment-list">
			<?php
				wp_list_comments( array(
					...
					'style'       => 'ol',
					'short_ping'  => true,
					'reply_text'  => /*twentyseventeen_get_svg( array( 'icon' => 'mail-reply' ) ) .*/ __( 'Reply', 'smoy' ),
				) );
			?>
		</ol>
	...
	if ( ! comments_open() && get_comments_number() && post_type_supports( get_post_type(), 'comments' ) ) : ?>
		...
		<p class="no-comments"><?php _e( 'Comments are closed.', 'smoy' ); ?></p>
	<?php
	endif;
