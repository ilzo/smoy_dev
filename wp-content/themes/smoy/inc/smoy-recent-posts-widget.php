<?php
/**
 * Widget API: Smoy_Recent_Posts_Widget class
 *
 * @package WordPress
 * @subpackage smoy
 * 
 ...
 *
 */
class Smoy_Recent_Posts_Widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		<?php while ( $r->have_posts() ) : $r->the_post(); ?>
			...
			<li class="post-link-container">
                <a href="<?php the_permalink(); ?>"><span class="latest-posts-symbol">&#187</span><?php get_the_title() ? the_title() : the_ID(); ?></a>
			</li>
		<?php endwhile; ?>
		</ul>
